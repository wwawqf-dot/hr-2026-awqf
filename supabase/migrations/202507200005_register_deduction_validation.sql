-- Validation hardening for register_deduction:
--   1. Duplicate check before INSERT into deductions
--   2. Reject negative customHolidays
--   3. Reject unreasonably large deduction (>366 days)
