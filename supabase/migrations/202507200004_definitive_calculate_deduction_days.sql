-- =====================================================================
--  Definitive calculate_deduction_days — strict DATE parameters
--  Drops all prior overloads that caused "function is not unique".
-- =====================================================================
...
grant execute on function public.calculate_deduction_days(date, date, numeric) to authenticated;

-- Update call site inside register_deduction to cast text -> date
